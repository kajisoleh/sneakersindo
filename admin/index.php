...
session_start();
//koneksi ke database
$koneksi = new mysqli("localhost", "root", "", "sneakersindo");
...
<head>
	...
	<title>Admin sneakers indo</title>
	<!-- BOOTSTRAP STYLES-->
...
<div id="wrapper">
	<nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
		...
		float: right;
		font-size: 16px;"> &nbsp; <a href="index.php?halaman=logout" class="btn btn-danger square-btn-adjust">Keluar</a> 
		</div>
	</nav>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li>
						<a href="index.php?halaman=logout"><i class="fa fa-sign-out"></i>Keluar</a>
					</li>      
				</ul>
			</div>   
    </nav>  
