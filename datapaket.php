...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS => "origin=342&destination=$distrik&weight=$berat&courier=$ekspedisi",
  CURLOPT_HTTPHEADER => array(
    "content-type: application/x-www-form-urlencoded",
    // Silahkan diisi dengan api_key dari rajaongkir.com
    "key:072a0b75e5273989f242697a903f7c09 "
  ),
));
...
if ($err) {
  ...
  // Mengambil harga paket dari nama kota 
